    ...
    firebase.database().ref('/alicebotStatus/').once('value').then(function (snapshot) {
        ...
        modules.forEach(element => {
            if (element.value == 'maintenance') {
                ...
                document.getElementById(`${element.name}-module-status`).style.boxShadow = '0px 0px 8px 0px #649bff'
                maintenance = true
                return
            }
            ...
            if (seconds > 60 && seconds < 120) {
                ...
                document.getElementById(`${element.name}-module-status`).style.boxShadow = '0px 0px 8px 0px #ffe10b'
                offlineModules--
                ...
                document.getElementById(`${element.name}-module-status`).style.boxShadow = '0px 0px 8px 0px #31ff0b'
                allModules++
                offlineModules--
            }
        });
        ...
        if (maintenance == true) {
            ...
            document.getElementById('alice-status').style.boxShadow = '0px 0px 8px 0px #649bff'
            ...
            document.getElementById('alice-status').style.boxShadow = '0px 0px 8px 0px #31ff0b'
        } else if (offlineModules >= 1 && offlineModules != 5) {
            document.getElementById('alice-status').style.background = '#fbd23e'
            document.getElementById('alice-status').style.boxShadow = '0px 0px 8px 0px #ffe10b'
    ...
    firebase.database().ref('/otherbotStatus/').once('value').then(function (snapshot) {
        ...
        modules.forEach(element => {
            if (element.value == 'maintenance') {
                ...
                document.getElementById(`${element.name}-status`).style.boxShadow = '0px 0px 8px 0px #649bff'
                maintenance = true
                return
            }
            let timestamp = element.value
            ...
            if (seconds > 60 && seconds < 120) {
                ...
                document.getElementById(`${element.name}-status`).style.boxShadow = '0px 0px 8px 0px #ffe10b'
                offlineModules--

                // Overall status update
                document.getElementById('bot-status').style.background = '#fbd23e'
                document.getElementById('bot-status').style.boxShadow = '0px 0px 8px 0px #ffe10b'
                ...
                document.getElementById(`${element.name}-status`).style.boxShadow = '0px 0px 8px 0px #31ff0b'
                allModules++
                offlineModules--
            }
        });
        ...
        if (maintenance == true) {
            ...
            document.getElementById('bot-status').style.boxShadow = '0px 0px 8px 0px #649bff'
            ...
            document.getElementById('bot-status').style.boxShadow = '0px 0px 8px 0px #31ff0b'
    ...
    firebase.database().ref('/websiteStatus/').once('value').then(function (snapshot) {
        ...
        modules.forEach(element => {
            ...
            if (status == 'offline') {
                ...
                document.getElementById(`${element.name}-status`).style.boxShadow = '0px 0px 8px 0px #ff0b0b'

                // Overall status update
                document.getElementById('website-status').style.background = '#fbd23e'
                document.getElementById('website-status').style.boxShadow = '0px 0px 8px 0px #ffe10b'
                ...
                document.getElementById('website-status').style.boxShadow = '0px 0px 8px 0px #31ff0b'
            }
        });
        // Overall status update
        if (maintenance == true) {
            ...
            document.getElementById('website-status').style.boxShadow = '0px 0px 8px 0px #649bff'
